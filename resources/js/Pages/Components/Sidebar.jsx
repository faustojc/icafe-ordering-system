                ...
                <ul id={"sidenav_tab"} data-tabs-toggle="#tab_content" role="tablist" className={"space-y-2 font-medium"}>
                    <li role={"presentation"}>
                        <button onClick={() => setActiveTab("orders")}
                                id="orders-tab" data-tabs-target="#orders-panel" type="button" role="tab" aria-controls="orders-panel" aria-selected="true"
                    ...
                    <li role={"presentation"}>
                        <button onClick={() => setActiveTab("products")}
                                id="products-tab" data-tabs-target="#products-panel" type="button" role="tab" aria-controls="products-panel" aria-selected="false"
                                className={"inline-block p-4 border-b-2 rounded-t-lg"}
                        >
                            Products
                        </button>
