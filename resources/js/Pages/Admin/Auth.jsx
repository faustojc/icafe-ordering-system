...
export default function Auth({error}) {
    ...
    const errorClass = 'border-red-300 text-red-900 placeholder-red-300 focus:ring-red-500 focus:border-red-500 dark:border-red-600 dark:focus:border-red-500 dark:focus:ring-red-500 dark:focus:border-red-500';
    const noErrorClass = 'border-gray-300 text-gray-900 focus:ring-blue-500 focus:border-blue-500 dark:text-white dark:border-gray-600 dark:focus:border-blue-500 dark:focus:ring-blue-500 dark:focus:border-blue-500';
                    ...
                    <form className={"space-y-6"} onSubmit={handleSubmit}>
                        <div className={"relative"}>
                            <input type={"text"} id={"username"} name={"username"}
                                   ...
                                   className={"block px-2.5 pb-2.5 pt-4 w-full text-sm bg-transparent rounded-lg border-1 appearance-none focus:ring-0 peer " + (error) ? errorClass : noErrorClass} />
