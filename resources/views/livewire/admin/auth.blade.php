<div class="flex items-center justify-center h-full">
    <div class="w-full max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700">
        <h5 class="text-xl text-center font-medium text-gray-900 dark:text-white mb-4" style="margin-bottom: 1.8rem">Admin Login</h5>

        @if(!empty($error))
            <div class="flex items-center p-4 my-3 text-sm text-red-800 border border-red-300 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400 dark:border-red-800" role="alert">
        ...
        <form class="space-y-6" wire:submit.prevent="login"> @csrf
            <div class="relative">
            ...
            >
                <span wire:loading wire:target="login" role="status" aria-hidden="true">
