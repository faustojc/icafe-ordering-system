<div>
    ...
    @else
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
            <div wire:loading>
                <div class="absolute top-0 left-0 w-full h-full bg-gray-900 bg-opacity-50 flex items-center justify-center">
                ...
                @foreach($this->products() as $product)
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                        ...
                        <td class="px-6 py-4 text-center">
                            ...
                            <button wire:click="$dispatch('set-data', {product_id: {{ $product->id }} })" wire:loading.attr="disabled"
                                    type="button" data-modal-toggle="delete_product_modal"
