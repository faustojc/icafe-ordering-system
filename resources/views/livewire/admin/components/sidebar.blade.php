<aside id="default-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700" aria-label="Sidebar">
    <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
        <ul class="space-y-2 font-medium" data-tabs-toggle="#tab_content" role="tablist">
            <li>
                <a href="#" id="orders-tab" data-tabs-target="#orders" role="tab" aria-controls="orders" aria-selected="true"
            ...
            <li>
                <a href="#" id="products-tab" data-tabs-target="#products" role="tab" aria-controls="products" aria-selected="false"
                   class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
                >
